...
- [floom](https://github.com/floomhq/floom) by [floomhq](https://github.com/floomhq) - Deploy Python scripts as cloud automations from Claude Code, Cursor, or any MCP-capable agent. Write a `run()` function, `/floom` handles the rest: sandbox testing, deployment, auto-generated web UI, REST API, and MCP endpoint. Includes a full skill with adapt-test-deploy flow.
